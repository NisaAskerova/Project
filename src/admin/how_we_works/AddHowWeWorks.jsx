...
function AddHowWeWorks() {
  ...
  const handleAboutUsSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:8000/api/how_we_works/main_info', formData, {
        headers: {
  ...
  const handleServiceSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:8000/api/how_we_works/service_info', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
