...
function ShowOurVision() {
  ...
  const fetchAboutUs = async () => {
    try {
      const response = await axios.get('http://localhost:8000/api/our_vision_mission/get_main_info');  // `get_main_info` istifadə edilir
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get('http://localhost:8000/api/our_vision_mission/get_service_info');  // `show_service_info` istifadə edilir
