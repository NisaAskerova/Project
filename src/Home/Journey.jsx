        ...
        <ScrollTrigger onEnter={()=>setCounterOn(true)} onExit={()=>setCounterOn(false)}>
            <div id='journey'>
                <div id='journeyLeft'>
                    ...
                    <h2 className='thick'>Trusted by 1000+ Happy
                    ...
                    <div id='journeyBoxes'>
                        <div className='joyrneyBox colmnLine' >
                            <div className='rowLine'>
                                ...
                                <h3 className='thick'>{counteOn && <CountUp start={0} end={150} duration={3} delay={0} />}+</h3>
                                <span className="same">Our Professional</span>
                            </div>
                            <div>
                                <h3 className='thick'>{counteOn &&<CountUp start={0} end={1000} duration={3} delay={0} />}+</h3>
                                <span className="same">Satisfied Clients</span>
                            </div>
                        </div>
                        <div className='joyrneyBox'>
                            <div className='rowLine'>
                                <h3 className='thick'>{counteOn &&<CountUp start={0} end={850} duration={3} delay={0} />}+</h3>
                                <span className="same">Projects Completed</span>
                            </div>
                            <div>
                                <h3 className='thick'>{counteOn &&<CountUp start={0} end={30} duration={3} delay={0} />}+</h3>
